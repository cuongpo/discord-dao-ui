// JavaScript code
// document.getElementById('link-discord').addEventListener('click', linkDiscord);

async function linkDiscordId() {
    ...
    await contract.methods.linkDiscordId(discordId).send({ from: accounts[0] });
